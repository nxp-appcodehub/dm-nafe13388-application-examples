...
- {id: CLK_144M_clock.outFreq, value: 144 MHz}
- {id: CLK_48M_clock.outFreq, value: 48 MHz}
- {id: FLEXCOMM1_clock.outFreq, value: 64 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: MAIN_clock.outFreq, value: 150 MHz}
- {id: PLL0_CLK_clock.outFreq, value: 150 MHz}
- {id: PLL1_CLK_clock.outFreq, value: 256 MHz}
- {id: PLL_DIV_clock.outFreq, value: 128 MHz}
- {id: Slow_clock.outFreq, value: 37.5 MHz}
- {id: System_clock.outFreq, value: 150 MHz}
- {id: gdet_clock.outFreq, value: 48 MHz}
- {id: pll1_clk0_clock.outFreq, value: 128 MHz}
- {id: trng_clock.outFreq, value: 48 MHz}
settings:
...
- {id: PLL1CLK0DIV_HALT, value: Enable}
...
- {id: SCG.PLL1M_MULT.scale, value: '32', locked: true}
- {id: SCG.PLL1SRCSEL.sel, value: SCG.FIRC_48M}
- {id: SCG.PLL1_NDIV.scale, value: '3', locked: true}
- {id: SCG.SCSSEL.sel, value: SCG.PLL0_CLK}
- {id: SYSCON.AHBCLKDIV.scale, value: '1', locked: true}
- {id: SYSCON.FCCLKSEL1.sel, value: SYSCON.PLL_DIV_CLK}
- {id: SYSCON.FLEXCOMM1CLKDIV.scale, value: '2', locked: true}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.PLL1CLK0DIV.scale, value: '2'}
- {id: SYSCON.PLLCLKDIVSEL.sel, value: SYSCON.pll1_clk0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll1Setup = {
        .pllctrl = SCG_SPLLCTRL_SOURCE(1U) | SCG_SPLLCTRL_SELI(19U) | SCG_SPLLCTRL_SELP(9U),
    ...
    CLOCK_AttachClk(kPLL1_CLK0_to_PLLCLKDIV);                 /*!< Switch PLLCLKDIV to PLL1_CLK0 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom1Clk, 2U);           /*!< Set FLEXCOMM1CLKDIV divider to value 2 */
    CLOCK_SetClkDiv(kCLOCK_DivPLL1Clk0, 2U);           /*!< Set PLL1CLK0DIV divider to value 2 */
