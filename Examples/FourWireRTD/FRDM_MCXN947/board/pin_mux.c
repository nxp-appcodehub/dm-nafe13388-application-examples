...
- {pin_num: M4, pin_signal: PIO1_23/FC4_P3/CT_INP15/SCT0_OUT5/FLEXIO0_D31/ADC1_A23, label: 'P1_23/J9[23]/SJ1[1]', identifier: NAFE_nINT}
...
- {pin_num: A6, pin_signal: PIO0_25/FC1_P1/CT0_MAT1/ADC0_B17, label: 'P0_25/J2[12]', identifier: FC1_CLK}
- {pin_num: B6, pin_signal: PIO0_24/FC1_P0/CT0_MAT0/ADC0_B16, label: 'P0_24/SJ7[1]', identifier: FC1_MOSI}
...
- {pin_num: D7, pin_signal: PIO0_31/CT_INP3/ADC0_B23, label: 'P0_31/J1[16]', identifier: NAFE_RST}
- {pin_num: E7, pin_signal: PIO0_30/FC1_P6/FC0_P6/CT_INP2/ADC0_B22, label: 'P0_30/SJ2[1]', identifier: NAFE_DRDY}
...
- {pin_num: F8, pin_signal: PIO0_29/FC1_P5/FC0_P5/CT_INP1/ADC0_B21, label: 'P0_29/J1[6]', identifier: TEST}
...
- {pin_num: E10, pin_signal: PIO0_27/FC1_P3/CT0_MAT3/ADC0_B19, label: 'P0_27/SJ6[1]', identifier: LED_GREEN;FC1_CS}
- {pin_num: F10, pin_signal: PIO0_26/FC1_P2/CT0_MAT2/ADC0_B18, label: 'P0_26/J2[10]', identifier: FC1_MISO}
...
- pin_list:
  ...
  - {pin_num: E10, peripheral: LP_FLEXCOMM1, signal: LPFLEXCOMM_P3, pin_signal: PIO0_27/FC1_P3/CT0_MAT3/ADC0_B19, identifier: FC1_CS}
  ...
  - {pin_num: C4, peripheral: GPIO1, signal: 'GPIO, 2', pin_signal: PIO1_2/TRIG_OUT0/FC3_P2/FC4_P6/CT1_MAT0/SCT0_IN6/FLEXIO0_D10/ENET0_MDC/SAI1_TXD0/CAN0_TXD/TSI0_CH2/ADC0_A18/CMP2_IN0,
    identifier: ADC_SYNC, direction: OUTPUT}
  - {pin_num: E7, peripheral: GPIO0, signal: 'GPIO, 30', pin_signal: PIO0_30/FC1_P6/FC0_P6/CT_INP2/ADC0_B22, direction: INPUT, gpio_per_interrupt: kGPIO_DMARisingEdge}
...
void BOARD_InitDEBUG_UARTPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_TEST_GPIO, BOARD_INITDEBUG_UARTPINS_TEST_PIN, &TEST_config);

    gpio_pin_config_t NAFE_DRDY_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_30 (pin E7)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_NAFE_DRDY_GPIO, BOARD_INITDEBUG_UARTPINS_NAFE_DRDY_PIN, &NAFE_DRDY_config);

    gpio_pin_config_t NAFE_RST_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO0_31 (pin D7)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_NAFE_RST_GPIO, BOARD_INITDEBUG_UARTPINS_NAFE_RST_PIN, &NAFE_RST_config);
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_ADC_SYNC_GPIO, BOARD_INITDEBUG_UARTPINS_ADC_SYNC_PIN, &ADC_SYNC_config);

    gpio_pin_config_t NAFE_nINT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_23 (pin M4)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_NAFE_nINT_GPIO, BOARD_INITDEBUG_UARTPINS_NAFE_nINT_PIN, &NAFE_nINT_config);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_FC1_MOSI_PORT, BOARD_INITDEBUG_UARTPINS_FC1_MOSI_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_FC1_CLK_PORT, BOARD_INITDEBUG_UARTPINS_FC1_CLK_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_FC1_MISO_PORT, BOARD_INITDEBUG_UARTPINS_FC1_MISO_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_FC1_CS_PORT, BOARD_INITDEBUG_UARTPINS_FC1_CS_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_TEST_PORT, BOARD_INITDEBUG_UARTPINS_TEST_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_NAFE_DRDY_PORT, BOARD_INITDEBUG_UARTPINS_NAFE_DRDY_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_NAFE_RST_PORT, BOARD_INITDEBUG_UARTPINS_NAFE_RST_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_ADC_SYNC_PORT, BOARD_INITDEBUG_UARTPINS_ADC_SYNC_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_NAFE_nINT_PORT, BOARD_INITDEBUG_UARTPINS_NAFE_nINT_PIN, kPORT_MuxAlt0);
...
- pin_list:
  - {pin_num: C4, peripheral: GPIO1, signal: 'GPIO, 2', pin_signal: PIO1_2/TRIG_OUT0/FC3_P2/FC4_P6/CT1_MAT0/SCT0_IN6/FLEXIO0_D10/ENET0_MDC/SAI1_TXD0/CAN0_TXD/TSI0_CH2/ADC0_A18/CMP2_IN0,
    identifier: LED_BLUE, direction: OUTPUT, slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable,
    invert_input: normal}
  ...
  - {pin_num: E10, peripheral: GPIO0, signal: 'GPIO, 27', pin_signal: PIO0_27/FC1_P3/CT0_MAT3/ADC0_B19, identifier: LED_GREEN, direction: OUTPUT, slew_rate: fast,
