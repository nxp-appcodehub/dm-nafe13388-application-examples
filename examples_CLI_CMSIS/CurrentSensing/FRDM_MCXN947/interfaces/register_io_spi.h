...
#include "frdm_stbi_nafe13388_shield.h"
...
#if NAFE13388_UIM
typedef void (*fpSpiCommandPreprocessFn_t)(void *pCmdOut,uint32_t size,void *pWritebuffer,uint16_t command);
#endif
...
#if NAFE13388_UIM
    fpSpiCommandPreprocessFn_t pCommandPreprocessFN;
#endif
    void *pTargetSlavePinID;
    uint8_t spiCmdLen;
