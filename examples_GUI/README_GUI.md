...
3. [Applications Overview and Test Results](#applications-overview-and-test-results)<br>
   3.1 [Voltage sensing using different reading modes](#voltage-sensing)<br>
   3.3 [Current sensing](#current-sensing-)<br>
   3.4 [Two-wire RTD](#two-wire-rtd)<br>
   3.5 [Four-wire RTD](#four-wire-rtd)<br>
   3.6 [Weight-scale](#weight-scale)<br>
...
- Download and install Annapurna2 GUI Setup.msi from this location:**examples_GUI/host_setup/Release**.
...
#### 3.1 Voltage sensing using different reading modes <a name="voltage-sensing"></a>
...
#### 3.2 Current sensing <a name="current-sensing"></a>
...
#### 3.4 Two wire RTD <a name="two-wire-rtd"></a>
...
#### 3.5 Four wire RTD <a name="four-wire-rtd"></a>
...
#### 3.6 Weight scale <a name="weight-scale"></a>
