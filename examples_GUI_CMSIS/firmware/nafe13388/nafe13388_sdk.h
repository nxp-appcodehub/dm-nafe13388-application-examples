...
/*! @brief This structure defines the input and output message via UART*/
typedef struct parse_vcom_t
{
	uint32_t isize;
	uint32_t osize;
	uint8_t *imsg;
...
/*! @brief       Function to enable DRDY pin.
 *  @details     This is the function to get control the DRDY pin.
 *  @param[in]   enable              bool variable.
 *  @constraints none
 *  @reentrant   No
 *  @return      ::void
 */
...
/*! @brief       Function to get samples.
 *  @details     This is the function to get a sample buffer array.
 *  @param[in]   index              to point to a particular index.
 *  @constraints none
 *  @reentrant   No
 *  @return      ::NAFE13388_getSample() returns the sample value at a particular index.
 */
