...
void BOARD_InitPins(void)
{
	...
	const port_pin_config_t port0_30_pinF8_config = {/* Internal pull-up/down resistor is disabled */
				kPORT_PullDisable,
		...
		/* PORT0_28 (pin F8) is configured as PIO0_28 */
		PORT_SetPinConfig(PORT0, 30U, &port0_30_pinF8_config);

		const port_pin_config_t port0_31_pinF8_config = {/* Internal pull-up/down resistor is disabled */
						kPORT_PullDisable,
						/* Low internal pull resistor value is selected. */
						kPORT_LowPullResistor,
						/* Fast slew rate is configured */
						...
						kPORT_UnlockRegister};
		/* PORT0_28 (pin F8) is configured as PIO0_28 */
		PORT_SetPinConfig(PORT0, 31U, &port0_31_pinF8_config);

		const port_pin_config_t port1_2_pinF8_config = {/* Internal pull-up/down resistor is disabled */
				kPORT_PullDisable,
				/* Low internal pull resistor value is selected. */
				kPORT_LowPullResistor,
				/* Fast slew rate is configured */
				...
				kPORT_UnlockRegister};
				/* PORT0_28 (pin F8) is configured as PIO0_28 */
		PORT_SetPinConfig(PORT1, 2U, &port1_2_pinF8_config);


    const port_pin_config_t port1_23_pinF8_config = {/* Internal pull-up/down resistor is disabled */
					kPORT_PullDisable,
					/* Low internal pull resistor value is selected. */
					kPORT_LowPullResistor,
					/* Fast slew rate is configured */
					...
					kPORT_UnlockRegister};
			/* PORT0_28 (pin F8) is configured as PIO0_28 */
			PORT_SetPinConfig(PORT1, 23U, &port1_23_pinF8_config);
